				...
				[
					{
						...
						id: 'tool-g3',
						name: 'Bash',
						input: {command: 'npm test', description: 'Run auth tests'} as ToolUseBlock['input'],
					},
				],
				...
				[
					{
						...
						input: {owner: 'example', repo: 'myapp', state: 'open'} as ToolUseBlock['input'],
					},
				],
				...
				[
					{
						...
						id: 'tool-mcp2',
						name: 'mcp__plugin_github_github__list_issues',
						input: {owner: 'example', repo: 'utils', state: 'open'} as ToolUseBlock['input'],
					},
				],
