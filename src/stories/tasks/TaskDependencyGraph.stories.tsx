...
const tasksWithDeps: GraphTask[] = [
	makeTask({taskId: '1', subject: 'Set up database', status: 'completed', blocks: ['2', '3']}),
	makeTask({taskId: '2', subject: 'Build API layer', status: 'in_progress', blockedBy: ['1'], blocks: ['4']}),
	makeTask({taskId: '3', subject: 'Design UI mockups', status: 'completed', blockedBy: ['1'], blocks: ['4']}),
	makeTask({taskId: '4', subject: 'Integrate frontend', status: 'pending', blockedBy: ['2', '3']}),
];
