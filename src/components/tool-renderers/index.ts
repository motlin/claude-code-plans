...
const ReadRenderer = lazy(() => import('./read-renderer').then((m) => ({default: m.ReadRenderer})));
...
const AskUserQuestionRenderer = lazy(() =>
	import('./ask-user-question-renderer').then((m) => ({default: m.AskUserQuestionRenderer})),
);
const AgentRenderer = lazy(() => import('./agent-renderer').then((m) => ({default: m.AgentRenderer})));
const TaskCreateRenderer = lazy(() => import('./task-create-renderer').then((m) => ({default: m.TaskCreateRenderer})));
const TaskUpdateRenderer = lazy(() => import('./task-update-renderer').then((m) => ({default: m.TaskUpdateRenderer})));
const TaskGetRenderer = lazy(() => import('./task-get-renderer').then((m) => ({default: m.TaskGetRenderer})));
const TaskListRenderer = lazy(() => import('./task-list-renderer').then((m) => ({default: m.TaskListRenderer})));
const ExitPlanModeRenderer = lazy(() =>
	import('./exit-plan-mode-renderer').then((m) => ({default: m.ExitPlanModeRenderer})),
);
const EnterPlanModeRenderer = lazy(() =>
	import('./enter-plan-mode-renderer').then((m) => ({default: m.EnterPlanModeRenderer})),
);
const TodoWriteRenderer = lazy(() => import('./todo-write-renderer').then((m) => ({default: m.TodoWriteRenderer})));
const WebSearchRenderer = lazy(() => import('./web-search-renderer').then((m) => ({default: m.WebSearchRenderer})));
const SendMessageRenderer = lazy(() =>
	import('./send-message-renderer').then((m) => ({default: m.SendMessageRenderer})),
);
const TaskStopRenderer = lazy(() => import('./task-stop-renderer').then((m) => ({default: m.TaskStopRenderer})));
const CronCreateRenderer = lazy(() => import('./cron-create-renderer').then((m) => ({default: m.CronCreateRenderer})));
const SkillRenderer = lazy(() => import('./skill-renderer').then((m) => ({default: m.SkillRenderer})));
const WebFetchRenderer = lazy(() => import('./webfetch-renderer').then((m) => ({default: m.WebFetchRenderer})));
const ToolSearchRenderer = lazy(() => import('./tool-search-renderer').then((m) => ({default: m.ToolSearchRenderer})));
