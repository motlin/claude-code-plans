      ...
      entries: [
        {
          ...
          occurrences: [
            ...
            { source: "tool", lineArrayIndex: 20, role: "assistant", tool: "Bash" },
          ],
        },
        {
          ...
          categoryId: "GitHub",
          occurrences: [{ source: "tool", lineArrayIndex: 30, role: "assistant", tool: "Bash" }],
        },
      ],
    },
    {
      ...
      entries: [
        {
          ...
          label: "Design notes",
          categoryId: "External",
          occurrences: [{ source: "thinking", lineArrayIndex: 40, role: "assistant" }],
        },
        {
          url: "https://example.com/guide",
          label: "Example guide",
          categoryId: "External",
          occurrences: [{ source: "visible", lineArrayIndex: 50, role: "user" }],
        },
      ],
    },
  ],
