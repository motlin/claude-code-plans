...
const cases: Case[] = [
	{
		name: 'SessionStart',
		payload: {...baseEnvelope, hook_event_name: 'SessionStart', source: 'startup'},
	},
	{
		name: 'SessionEnd',
		payload: {...baseEnvelope, hook_event_name: 'SessionEnd', reason: 'logout'},
	},
	{
		name: 'Stop',
		payload: {...baseEnvelope, hook_event_name: 'Stop', stop_hook_active: false},
	},
	{
		name: 'SubagentStop',
	...
	},
	{
		...
		payload: {...baseEnvelope, hook_event_name: 'UserPromptSubmit', prompt: 'fix the bug'},
	},
	{
		name: 'Notification',
		payload: {...baseEnvelope, hook_event_name: 'Notification', message: 'idle'},
	},
	{
		name: 'PreCompact',
		payload: {...baseEnvelope, hook_event_name: 'PreCompact', trigger: 'auto'},
	},
	{
		name: 'PreToolUse',
		payload: {
	...
	{
		name: 'WorktreeCreate',
		payload: {...baseEnvelope, hook_event_name: 'WorktreeCreate', name: 'wt-foo'},
	},
];
...
describe('hook stdin -> jq filter -> HookEventEnvelope round-trip', () => {
	...
	it('attaches every CLAUDE-prefixed env var under claude_env', () => {
		const transformed = jqRoundTrip({...baseEnvelope, hook_event_name: 'Stop'}) as {
