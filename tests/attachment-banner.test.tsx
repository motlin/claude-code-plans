...
const MINIMAL_BY_TYPE: Record<string, AttachmentPayload> = {
	...
	hook_success: {type: 'hook_success', hookName: 'h', hookEvent: 'PreToolUse'},
	hook_non_blocking_error: {type: 'hook_non_blocking_error', hookName: 'h', hookEvent: 'PreToolUse'},
	hook_blocking_error: {type: 'hook_blocking_error', hookName: 'h', hookEvent: 'PreToolUse'},
	hook_cancelled: {type: 'hook_cancelled', hookName: 'h', hookEvent: 'PreToolUse'},
	hook_system_message: {type: 'hook_system_message', hookName: 'h', hookEvent: 'PreToolUse'},
	hook_additional_context: {type: 'hook_additional_context', hookName: 'h', hookEvent: 'PreToolUse'},
