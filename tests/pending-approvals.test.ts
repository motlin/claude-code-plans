			...
			jsonl(
				...
				},
				{
					...
					message: {
						role: 'user',
						content: [
							{type: 'tool_result', tool_use_id: 'toolu_abc', content: 'User has approved your plan.'},
						],
					},
				},
			),
			...
			jsonl(
				...
				},
				{
					...
					message: {
						role: 'user',
						content: [
							{type: 'tool_result', tool_use_id: 'toolu_first', content: 'User has approved your plan.'},
						],
					},
				},
				{
